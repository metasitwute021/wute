...
//|                                                                  |
//|  *** TUNED 2026-06-05 -> full "KRV-DC V.17"-like config ***       |
...
//+------------------------------------------------------------------+
#property copyright "XAUUSD Donchian EA (merged: Donchian-SL + OrderCalcProfit sizing)"
