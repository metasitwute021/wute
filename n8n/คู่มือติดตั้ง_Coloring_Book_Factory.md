...
| รายการ | ราคา |
|---|---|
| gpt-image-1 ขนาด 1536x1024 quality `medium` × 6 ภาพ | ~$0.42 (~15 บาท) |
| gpt-4.1-mini (agents 3 ตัว) | ~$0.01 |
| **รวม** | **~$0.43/ชุด** — รันทุกวันทั้งเดือน ~$13 |

ประหยัดขึ้น: เปลี่ยน `image_quality` ในโหนด **Config** เป็น `low` (~$0.11/ชุด) / สวยสุด `high` (~$1.10/ชุด)
