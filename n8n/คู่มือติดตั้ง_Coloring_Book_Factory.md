...
| ภาพรก เส้นเยอะ ของล้นหน้า | โหนด **Agent 3** → ลดตัวเลขในข้อ 2 ของ checklist (ตอนนี้ในห้อง 9 ชิ้น นอกห้อง 4 ชิ้น) ให้น้อยลง |
| ภาพโล่งเกินไป | ทำกลับกัน — เพิ่มตัวเลขในข้อ 2 ของ Agent 3 (และของ Agent 1 ที่เขียนว่า `7-9 main props`) |
